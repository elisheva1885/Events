...
export function RegisterPage({ onRegister, onNavigate }: RegisterPageProps) {
  ...
  const validatePhone = (phone: string) => {
    ...
    if (!phoneRegex.test(phone))
      return "מספר טלפון חייב להתחיל ב-05 ולהכיל 10 ספרות";
    return "";
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await register({
        ...
        phone,
        password,
        ...(role === "supplier" && { category, regions, description, kashrut }),
      },role);
      if (role === "supplier") {
        setStep(2);
      } else {
          ...
          <>
            <div className="p-10 border border-gray-100 shadow-xl bg-white/80 backdrop-blur-xl rounded-3xl">
              <div className="mb-10 text-center">
                ...
                <h1 className="text-[#2d2d35] mb-3 text-3xl font-light">
                  הרשמה למערכת
                </h1>
                <p className="text-[#6d6d78] text-base font-light">
                  צרו חשבון חדש והתחילו לנהל את האירוע שלכם
                </p>
              </div>
  {/* בחירת סוג חשבון */}
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="space-y-2">
                  <label
                    htmlFor="name"
                    className="text-[#2d2d35] text-sm font-light block"
                  >
                    שם מלא
                  </label>
                  ...
                  {errors.name && (
                    <div className="flex items-center gap-2 mt-1">
                      ...
                      <p className="text-xs text-[#ef4444] font-light">
                        {errors.name}
                      </p>
                    </div>
                  )}
                    ...
                    <div className="mt-3 space-y-2">
                      {!passwordRequirements.minLength && (
                        <div className="flex items-center gap-2">
                          ...
                          <p className="text-xs text-[#f59e0b] font-light">
                            לפחות 8 תווים
                          </p>
                        </div>
                      )}
                ...
                {role === "supplier" && (
                  <>
                    ...
                    <input
                      id="category"
                      type="text"
                      placeholder="קטגוריה (לדוגמה: צלם, עיצוב, קייטרינג)"
                      ...
                      required
                      className="w-full pr-12 h-12 rounded-xl border border-[#e3e3e6] focus:border-[#d4a960] focus:ring-2 focus:ring-[#d4a960]/20 bg-white/50 text-[#2d2d35] px-4 font-light outline-none transition-all"
                    />

                    <input
                      id="regions"
                      type="text"
                      placeholder="אזורי פעילות (למשל: מרכז, דרום, צפון)"
                ...
                <div className="flex items-start gap-3">
                  ...
                  <span className="text-[#6d6d78] text-sm leading-relaxed font-light">
                    ...
                    <button
                      type="button"
                      className="text-[#d4a960] hover:text-[#c89645] transition-colors"
                    >
                      תנאי השימוש
                    </button>{" "}
                    ו
              ...
              <div className="relative my-8">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-4 bg-white/80 text-[#6d6d78] font-light">
                    או
                  </span>
                </div>
              </div>
        ...
        {step === 2 && role === "supplier" && (
          <MediaUploader onRegister={onRegister} />
        )}
      </div>
    </div>
  );
